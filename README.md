...
The proposed model is a dense _Simultaneous Localization and Mapping_ (SLAM) system that aims to leverage 3D Gaussian Splatting to achieve photo-realistic reconstructions. For the last-year excellence program at Sapienza University of Rome, the project focuses on trying to develop a model for SLAM using _Gaussian representations_. SLAM is a critical component in robotics and computer vision, enabling robots and autonomous systems to navigate and map their environment. 
