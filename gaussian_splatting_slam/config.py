...
Method = MethodSpecification(
    ...
    steps_per_eval_image=201, # da 100
    steps_per_eval_batch=0,
    steps_per_save= 4000, # da 2000
    steps_per_eval_all_images=1000, # da 500
    max_num_iterations=60000, # da 30000
    ...
    pipeline=MyPipelineConfig(
        ...
        model=MyModelConfig(
            _target=MyModel, 
            refine_every=201, # da 100
            warmup_length=800, # da 500
            reset_alpha_every=61, # da 30
